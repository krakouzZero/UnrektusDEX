...
import type { FarmBooster, FarmBoosterInterface } from "../FarmBooster";
...
export class FarmBooster__factory {
  static readonly abi = _abi;
  static createInterface(): FarmBoosterInterface {
    return new utils.Interface(_abi) as FarmBoosterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FarmBooster {
    return new Contract(address, _abi, signerOrProvider) as FarmBooster;
  }
}
