...
import type {
  BCakeFarmBooster,
  BCakeFarmBoosterInterface,
} from "../BCakeFarmBooster";
...
export class BCakeFarmBooster__factory {
  static readonly abi = _abi;
  static createInterface(): BCakeFarmBoosterInterface {
    return new utils.Interface(_abi) as BCakeFarmBoosterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BCakeFarmBooster {
    return new Contract(address, _abi, signerOrProvider) as BCakeFarmBooster;
  }
}
