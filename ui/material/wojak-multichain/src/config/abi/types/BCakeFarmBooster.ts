...
export interface BCakeFarmBoosterInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "WOJKPOOL", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "WOJKPOOL", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "CA_PRECISION",
    data: BytesLike
  ): Result;
...
export interface BCakeFarmBooster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BCakeFarmBoosterInterface;
  ...
  functions: {
    ...
    WOJKPOOL(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WOJKPOOL(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WOJKPOOL(overrides?: CallOverrides): Promise<PopulatedTransaction>;
