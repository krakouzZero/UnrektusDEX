...
export interface CakeVaultV2Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "calculateTotalPendingWojkRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CakeVaultV2 extends BaseContract {
  ...
  functions: {
    ...
    wojkPoolPID(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    calculateTotalPendingWojkRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    wojkPoolPID(overrides?: CallOverrides): Promise<PopulatedTransaction>;
