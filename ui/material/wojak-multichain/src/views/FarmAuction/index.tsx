...
// import { Breadcrumbs, Button, Flex, Heading, Link, Text } from '@pancakeswap/uikit'
...
// const WOJKBURN_BG_LIGHT = 'radial-gradient(50% 79.31% at 50% 50%, #FAF9FA 0%, #EAECF4 100%)'
// const WOJKBURN_TOP_FILL_LIGHT = 'radial-gradient(ellipse at bottom, #f0f1f6, #EAECF4)'
// const WOJKBURN_BG_DARK = 'radial-gradient(103.12% 50% at 50% 50%, #152534 0%, #191326 100%)'
// const WOJKBURN_TOP_FILL_DARK = '#191326'
  ...
  return (
    <>
      ...
      <>
        ...
        <PageSection
          background={theme.isDark ? WOJKBURN_BG_DARK : WOJKBURN_BG_LIGHT}
          index={2}
          innerProps={{ style: { width: '100%' } }}
          dividerPosition="top"
          dividerFill={{ light: WOJKBURN_TOP_FILL_LIGHT, dark: WOJKBURN_TOP_FILL_DARK }}
        >
          <AuctionCakeBurn />
        </PageSection>
        <PageSection
          ...
          dividerFill={{ light: WOJKBURN_BG_LIGHT, dark: WOJKBURN_BG_DARK }}
          concaveDivider
          index={3}
          dividerPosition="top"
        >
