          ...
          <Flex flexDirection="column">
            ...
            <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
              <Flex flexDirection={['column', 'column', 'row']} mb={['8px', '8px', null]}>
                <NextLinkFromReactRouter
                  to={`/info/token/${poolData.token0.address}?chain=${CHAIN_QUERY_NAME[chainId]}`}
                >
                  <TokenButton>
                ...
                <NextLinkFromReactRouter
                  to={`/info/token/${poolData.token1.address}?chain=${CHAIN_QUERY_NAME[chainId]}`}
                >
              ...
              <Flex>
                ...
                <NextLinkFromReactRouter
                  to={`/swap?inputCurrency=${poolData.token0.address}&outputCurrency=${poolData.token1.address}?chain=${CHAIN_QUERY_NAME[chainId]}`}
                >
