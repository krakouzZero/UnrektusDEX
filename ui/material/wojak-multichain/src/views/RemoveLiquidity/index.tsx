...
import { ChainId, Currency, Percent, WNATIVE } from '@pancakeswap/sdk'
import {
  AddIcon,
  ArrowDownIcon,
  Box,
...
const zapSupportedChainId = [ChainId.BSC, ChainId.BSC_TESTNET, ChainId.DOGECHAIN]
