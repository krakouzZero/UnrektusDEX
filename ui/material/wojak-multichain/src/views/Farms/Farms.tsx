...
import { Box, Flex, Heading, Text, Toggle } from '@pancakeswap/uikit'
...
const Farms: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const background = '/images/decorations/farmz_bg.png'
    ...
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      <PageHeader background={background}>
        <FarmFlexWrapper justifyContent="space-between">
          ...
          {(chainId === ChainId.DOGECHAIN || chainId === ChainId.BSC_TESTNET) && (
            <Box>
              <BCakeBoosterCard />
            </Box>
          )}
