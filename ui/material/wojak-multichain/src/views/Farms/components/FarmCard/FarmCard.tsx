...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('WOJK + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'WOJK'
      ...
      <FarmCardInnerContainer>
        ...
        {!removed && (
          <Flex justifyContent="space-between" alignItems="center">
            <Text>{t('APR')}:</Text>
            <Text color="contrast" bold style={{ display: 'flex', alignItems: 'center' }}>
              {farm.apr ? (
                <>
                  {farm.boosted ? (
      ...
      <ExpandingWrapper>
        ...
        {showExpandableSection && (
          <DetailsSection
            ...
            infoAddress={`/info/pool/${lpAddress}?chain=${CHAIN_QUERY_NAME[chainId]}`}
