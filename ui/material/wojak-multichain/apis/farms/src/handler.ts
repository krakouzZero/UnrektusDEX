...
import { BUSD, WOJK } from '@pancakeswap/tokens'
...
const cakeBusdPairMap = {
  [ChainId.BSC]: {
    address: Pair.getAddress(WOJK[ChainId.BSC], BUSD[ChainId.BSC]),
    tokenA: WOJK[ChainId.BSC],
    tokenB: BUSD[ChainId.BSC],
  },
  [ChainId.BSC_TESTNET]: {
    address: Pair.getAddress(WOJK[ChainId.BSC_TESTNET], BUSD[ChainId.BSC_TESTNET]),
    tokenA: WOJK[ChainId.BSC_TESTNET],
